        ...
        <div className="container">
          <div className="header-content row">
            <div className="col-xs-12 col-sm-5 col-md-5">
              ...
              <p>
              </p><div className="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s" onClick={justclick}><i className="hbtn" /> <span>Free Download</span> <i className="fa fa-cloud-download" />
              </div>
              <p />
            </div>
            ...
            <div className="col-xs-12 col-sm-4 col-md-4">
              <div className="row">     
                ...
                <div className="col-xs-2 col-sm-2 col-md-2 wow fadeInRight animated" data-wow-delay=".5s">
                  <i className="fa fa-apple iconfont" />
                </div>    
              </div>
              <div className="row"> 
                ...
                <div className="col-xs-2 col-sm-2 col-md-2 wow fadeInRight animated" data-wow-delay=".6s">
                  <i className="fa fa-rocket iconfont" />
                </div>     
              </div>
              <div className="row">            
                ...
                <div className="col-xs-2 col-sm-2 col-md-2 wow fadeInRight animated" data-wow-delay=".7s">
                  <i className="fa fa-film iconfont" />
                </div>         
              </div>        
            </div>
            ...
            <div className="col-xs-12 col-sm-4 col-md-4">
              <div className="row">         
                <div className="col-xs-2 col-sm-2 col-md-2 wow fadeInLeft animated" data-wow-delay=".5s">
                  <i className="fa fa-android iconfont2" />
                </div>    
              ...
              <div className="row">    
                <div className="col-xs-2 col-sm-2 col-md-2 wow fadeInLeft animated" data-wow-delay=".6s">
                  <i className="fa fa-css3 iconfont2" />
                </div>          
              ...
              <div className="row">    
                <div className="col-xs-2 col-sm-2 col-md-2 wow fadeInLeft animated" data-wow-delay=".7s">
                  <i className="fa fa-users iconfont2" />
                </div>          
                ...
                <div className="col-xs-12 col-sm-12 col-md-12 wow zoomIn animated textright" data-wow-delay=".1s">           
                  <div className="span12">
                    <div id="owl-demo" className="owl-carousel">
                      <div className="item">
                        <div className="imghover" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><img src="img/owl1.jpg" alt="Owl Image" />         
                          <div className="hover-bg"><i className="fa fa-camera camera" /></div>                 
                        </div> 
                      </div>
                      <div className="item">
              ...
              <div className="price-wrapper ">
                ...
                <div className="price">
                  <div className="value-box">
                    <div className="value-box-content">
                      <span className="value">
                        <i /><span className="number">FREE</span>
                      </span>
                      <span className="month invisible" />
                    </div>
                  </div>
                  ...
                  <div className="sign-box">
                    <a href="#" onClick={justclick}><span>Sign Up</span></a>			
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="price-wrapper ">
                ...
                <div className="price">
                  <div className="value-box">
                    <div className="value-box-content">
                      <span className="value">
                        <i /><span className="number"> $10 </span>
                      </span>
        ...
        <div className="container">
          ...
          <div className="row">
              ...
              <form>
                <div className="ajax-hidden">
                  ...
                  <div data-wow-delay=".2s" className="form-group wow fadeInUp animated">
                    <textarea placeholder="Message" rows={7} name="c_message" id="c_message" className="form-control" defaultValue={""} />
                  </div>
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated map" data-wow-delay=".5s">
              <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d6508922.473104964!2d-123.76275651635396!3d37.19583981824279!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sCalifornia%2C+United+States!5e0!3m2!1sen!2sin!4v1450994260631" width="100%" height={250} frameBorder={0} style={{border: 0}} allowFullScreen />
            </div>
            <div className="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".6s">
              <section id="text-15" className="widget widget_text">
                <h3 className="widget-title">California, United States</h3> <div className="textwidget">785, Firs Avenue, place Mall,<br />
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12">
              <ul className="social-links">
                ...
                <li><a data-wow-delay=".5s" className="wow fadeInUp animated" href="index.html#" style={{visibility: 'visible', animationDelay: '0.5s', animationName: 'fadeInUp'}}><i className="fa fa-envelope" /></a></li>
              </ul>
