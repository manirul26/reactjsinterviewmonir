    ...
    <div className="container">
      <div className="header-content row">
        <div className="col-xs-12 col-sm-5 col-md-5">
          ...
          <p>
          </p><div className="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s"><i className="hbtn" /> <span>Free Download</span> <i className="fa fa-cloud-download" />
          </div>
          <p />
        </div>
